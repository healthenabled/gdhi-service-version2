...
public class CountryHealthIndicatorServiceTest {
    ...
    private void dataSet(String countryId1, int categoryId1, int categoryId2,
        ...
        IndicatorScore indicatorScore1 =
                IndicatorScore.builder().id(1L).indicatorId(indicatorId2).score(score2).definition("score 1").build();
        CountryHealthIndicator countryHealthIndicator1 = new CountryHealthIndicator(countryHealthIndicatorId1, country1,
                category1, indicator1, indicatorScore1, score1, "st1", new Date(), null, publishedStatus);

        CountryHealthIndicatorId countryHealthIndicatorId2 = new CountryHealthIndicatorId(countryId1, categoryId2,
                indicatorId2, year);
        ...
        IndicatorScore indicatorScore2 =
                IndicatorScore.builder().id(1L).indicatorId(indicatorId2).score(score2).definition("score 2").build();
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category2, indicator2, indicatorScore2, score2, "st2", new Date(), null, publishedStatus);
        IndicatorScore indicatorScore3 =
                IndicatorScore.builder().id(2L).indicatorId(indicatorId3).score(score3).definition("score 3").build();
        CountryHealthIndicator countryHealthIndicator3 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category2, indicator3, indicatorScore3, score3, "st3", new Date(), null, publishedStatus);

        List<CountryHealthIndicator> countryHealthIndicatorsForCountry = asList(countryHealthIndicator3,
                countryHealthIndicator2,
                countryHealthIndicator1);

        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdCountryIdAndCountryHealthIndicatorIdYearAndStatus(countryId1, year,
                publishedStatus)).thenReturn(countryHealthIndicatorsForCountry);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForDifferentCategory() {
        ...
        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(1, "Leadership and Governance",
                3.0, 3,
                of(new IndicatorScoreDto(1, null, "Indicator 1", "Definition1", 1, 3, "st1", "score 1")));
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(2, "Category2", 2.5, 3,
                of(new IndicatorScoreDto(2, null,
                        "Indicator 2", "Definition2", 2, 4, "st2", "score 2"), new IndicatorScoreDto(3, null,
                        "Indicator 3",
                        "Definition3", 3, 1, "st3",
                        "score 3")));
        CountryHealthScoreDto countryHealthScoreDto = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryHealthScoreDto1,
                        categoryHealthScoreDto2), 3, "");
        when(indicatorTranslator.translateCountryHealthScores(en, countryHealthScoreDto)).thenReturn(countryHealthScoreDto);

        CountryHealthScoreDto healthScoreForACountry =
    ...
    public void shouldReturnCountryHealthScoresInSpanishGivenCountryIdAndYear() {
        ...
        CountryHealthScoreDto countryHealthScoreDtoEN = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryHealthScoreDto1,
                        categoryHealthScoreDto2), 3, "");
        CategoryHealthScoreDto categoryHealthScoreDto3 = new CategoryHealthScoreDto(1, "Leadership and Governance " +
                "Spanish", 3.0, 3,
                of(new IndicatorScoreDto(1, null, "Indicator 1 Spanish", "Definition1 Spanish", 1, 3, "st1", "score 1" +
                        " Spanish")));
        CategoryHealthScoreDto categoryHealthScoreDto4 = new CategoryHealthScoreDto(2, "Category2 Spanish", 2.5, 3, of(
                new IndicatorScoreDto(2, null, "Indicator 2 Spanish", "Definition2 Spanish", 2, 4, "st2", "score 2 " +
                        "Spanish"),
                new IndicatorScoreDto(3, null, "Indicator 3 Spanish", "Definition3 Spanish", 3, 1, "st3", "score 3 " +
                        "Spanish")));
        CountryHealthScoreDto countryHealthScoreDtoES = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryHealthScoreDto3,
                        categoryHealthScoreDto4), 3, "");

        when(indicatorTranslator.translateCountryHealthScores(es, countryHealthScoreDtoEN)).thenReturn(countryHealthScoreDtoES);

        CountryHealthScoreDto healthScoreForACountry =
                countryHealthIndicatorService.fetchCountryHealthScore(countryId, es, year);

        assertEquals(countryHealthScoreDtoES, healthScoreForACountry);
    }

    @Test
    public void shouldReturnLatestCountryHealthScoreForGivenCountryId() {
        String countryId = "SDN";
        String year = "2024";
        Category category = Category.builder().id(1).name("Leadership and Governance").build();
        Country country = new Country(countryId, "Sudan", UUID.randomUUID(), "SD");
        Indicator indicator = Indicator.builder().indicatorId(1).rank(1).build();
        CountryHealthIndicator countryHealthIndicator = CountryHealthIndicator.builder()
                .countryHealthIndicatorId(new CountryHealthIndicatorId(countryId, 1, 1, year))
                .country(country)
                .category(category)
                .indicator(indicator)
                .score(4)
        ...
        when(iCountryHealthIndicatorRepository.findLatestByCountryAndCategoryAndStatus(countryId, null, PUBLISHED.name()))
                .thenReturn(asList(countryHealthIndicator));
        when(iCountryPhaseRepository.findLatestByCountryId(countryId))
                .thenReturn(new CountryPhase(countryId, 3, year, true));
        when(iCountrySummaryRepository.findLatestByCountryIdAndStatus(countryId, PUBLISHED.name()))
                .thenReturn(CountrySummary.builder()
                        .countrySummaryId(new CountrySummaryId(countryId, year))
                        .build());
        when(indicatorTranslator.translateCountryHealthScores(eq(en), any(CountryHealthScoreDto.class)))
                .thenAnswer(invocation -> invocation.getArgument(1));

        CountryHealthScoreDto healthScore =
                countryHealthIndicatorService.fetchLatestCountryHealthScore(countryId, en);

        assertThat(healthScore.getCountryId(), is(countryId));
        assertThat(healthScore.getCountryName(), is("Sudan"));
        assertThat(healthScore.getCountryAlpha2Code(), is("SD"));
        assertThat(healthScore.getCountryPhase(), is(3));
        assertThat(healthScore.getCategories().size(), is(1));
        verify(iCountryHealthIndicatorRepository).findLatestByCountryAndCategoryAndStatus(countryId, null,
                PUBLISHED.name());
        verify(iCountryPhaseRepository).findLatestByCountryId(countryId);
        verify(iCountrySummaryRepository).findLatestByCountryIdAndStatus(countryId, PUBLISHED.name());
    }
    ...
    private void assertSet1(CountryHealthScoreDto healthScoreForACountry, String countryId, String countryName) {
        ...
        CategoryHealthScoreDto leadership =
                healthScoreForACountry.getCategories().stream().filter(a -> a.getName().equals("Leadership and " +
                        "Governance")).findFirst().get();
        CategoryHealthScoreDto category2 =
                healthScoreForACountry.getCategories().stream().filter(a -> a.getName().equals("Category2")).findFirst().get();
        assertThat(leadership.getPhase(), is(3));
        assertThat(leadership.getIndicators().size(), is(1));
        IndicatorScoreDto indicator =
                leadership.getIndicators().stream().filter(ind -> ind.getId().equals(1)).findFirst().get();
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForDifferentNullIndicatorScoreForSameCategory() {
        ...
        CountryHealthIndicatorId countryHealthIndicatorId2 = new CountryHealthIndicatorId(countryId, categoryId1,
                indicatorId2,
                year);
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        Integer indicatorScore = 2;
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category1, indicator2, IndicatorScore.builder().build(), indicatorScore, "st1", new Date(),
                null, publishedStatus);

        List<CountryHealthIndicator> countryHealthIndicatorsForCountry = asList(countryHealthIndicator1,
                countryHealthIndicator2);

        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdCountryIdAndCountryHealthIndicatorIdYearAndStatus(countryId, year,
                publishedStatus)).thenReturn(countryHealthIndicatorsForCountry);
    ...
    private void assertSet4(CountryHealthScoreDto healthScoreForACountry, String countryId, String countryName,
        ...
        List<CategoryHealthScoreDto> leadership =
                healthScoreForACountry.getCategories().stream().filter(a -> a.getName().equals("Leadership and " +
                        "Governance")).collect(toList());
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForANullCategoryScore() {
        ...
        CountryHealthIndicatorId countryHealthIndicatorId2 = new CountryHealthIndicatorId(countryId1, categoryId1,
                indicatorId2, year);
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
        ...
        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(1, categoryName, -1.0, -1,
                of(new IndicatorScoreDto(1, null,
                        "Indicator 1", "Definition", 1, null, "st1", "Not Available")));
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(2, categoryName2, 2.0, 2,
                of(new IndicatorScoreDto(2, null,
                        "Indicator 1", "Definition", 2, 2, "st2", "Not Available")));
        CountryHealthScoreDto countryHealthScoreDto = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryHealthScoreDto1,
                        categoryHealthScoreDto2), 2, "");
        when(indicatorTranslator.translateCountryHealthScores(en, countryHealthScoreDto)).thenReturn(countryHealthScoreDto);
    ...
    public void shouldReturnCountryHealthScoreWithoutConsideringNegativeScores() {
        ...
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category2, indicator2, IndicatorScore.builder().indicatorId(indicatorId2).score(2).build(),
                2, "st2", new Date(), null, publishedStatus);
        ...
        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(1, "Leadership and Governance",
                -1.0, -1,
                of(new IndicatorScoreDto(1, null, "Indicator 1", "Definition", 1, null, "st1", "Not Available")));
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(2, "Category2", 2.0, 2,
                of(new IndicatorScoreDto(2, null,
                        "Indicator 1", "Definition", 2, 2, "st2", "Not Available")));
        CountryHealthScoreDto countryHealthScoreDto = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryHealthScoreDto1,
    ...
    private void assertSet5(CountryHealthScoreDto healthScoreForACountry, String countryId, String countryName) {
        ...
        List<CategoryHealthScoreDto> leadership =
                healthScoreForACountry.getCategories().stream().filter(a -> a.getName().equals("Leadership and " +
                        "Governance")).collect(toList());
        List<CategoryHealthScoreDto> category2 =
                healthScoreForACountry.getCategories().stream().filter(a -> a.getName().equals("Category2")).collect(toList());
        assertThat(leadership.size(), is(1));
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForNullCountryScore() {
        ...
        CountryHealthScoreDto countryHealthScoreDto = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryHealthScoreDto1), null, "");
        when(indicatorTranslator.translateCountryHealthScores(en, countryHealthScoreDto)).thenReturn(countryHealthScoreDto);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForSameCategory() {
        ...
        Indicator indicator1 = new Indicator(indicatorId1, "Indicator 1", "Definition", 1);
        CountryHealthIndicator countryHealthIndicator1 = new CountryHealthIndicator(countryHealthIndicatorId1,
                country1, category1, indicator1, IndicatorScore.builder().build(), indicatorScore1, "st1", new Date()
                , null, publishedStatus);
        ...
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category1, indicator2, IndicatorScore.builder().build(), indicatorScore2, "st2", new Date()
                , null, publishedStatus);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForSameCategoryCheckingSinglePrecision() {
        ...
        CountryHealthIndicatorId countryHealthIndicatorId3 = new CountryHealthIndicatorId(countryId1, categoryId1,
                indicatorId3, year);
        ...
        CountryHealthIndicator countryHealthIndicator3 = new CountryHealthIndicator(countryHealthIndicatorId3,
                country1, category1, indicator3, IndicatorScore.builder().build(), indicatorScore3, "st3", new Date()
                , null, publishedStatus);

        List<CountryHealthIndicator> countryHealthIndicatorsForCountry = asList(countryHealthIndicator1,
                countryHealthIndicator2,
                countryHealthIndicator3);
    ...
    public void shouldFetchGlobalHealthScores() throws Exception {
        ...
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdYearAndStatus(year, PUBLISHED.name())).thenReturn(asList(mock1, mock2,
                mock3, mock4));

        CountrySummary countrySummary = CountrySummary.builder().build();
        when(iCountrySummaryRepository.findByCountrySummaryIdCountryIdAndCountrySummaryIdYearAndStatus(anyString(), anyString(),
                anyString())).thenReturn(countrySummary);
        ...
        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(9, "Category 1", 1.0, 1, of(new IndicatorScoreDto(1, null, null
                , null, null, 1, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoIN = new CountryHealthScoreDto("IND", "India", "IN", of(categoryHealthScoreDto1), 1, "");

        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(7, "Category 4", 3.5, 4,
                of(new IndicatorScoreDto(3, null, null, null, null, 3, null, null),
                        new IndicatorScoreDto(4, null, null, null, null, 4, null, null)));
        CategoryHealthScoreDto categoryHealthScoreDto3 = new CategoryHealthScoreDto(8, "Category 2", 2.0, 2, of(
                new IndicatorScoreDto(2, null, null, null, null, 2, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoUS = new CountryHealthScoreDto("USA", "United States", "US", of(categoryHealthScoreDto2,
                categoryHealthScoreDto3), 3, "");

        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(en, countryHealthScoreDtoUS)).thenReturn(countryHealthScoreDtoUS);
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(en, countryHealthScoreDtoIN)).thenReturn(countryHealthScoreDtoIN);
        ...
        CountryHealthScoreDto actualInd =
                countriesHealthScoreDto.getCountryHealthScores().stream().filter(c -> c.getCountryId().equals("IND")).findFirst().get();
        CountryHealthScoreDto actualUSA =
                countriesHealthScoreDto.getCountryHealthScores().stream().filter(c -> c.getCountryId().equals("USA")).findFirst().get();
        ...
        CategoryHealthScoreDto actualCategory3 =
                actualUSA.getCategories().stream().filter(c -> c.getId().equals(category3.getId())).findFirst().get();
        assertThat(actualCategory3.getOverallScore(), is(3.5));
        assertThat(actualCategory3.getIndicators().size(), is(2));
        CategoryHealthScoreDto actualCategory2 =
                actualUSA.getCategories().stream().filter(c -> c.getId().equals(category2.getId())).findFirst().get();
        assertThat(actualCategory2.getOverallScore(), is(2.0));
    }

    @Test
    public void shouldFetchLatestHealthScoresUsingLatestCountryPhaseRows() {
        Category category1 = Category.builder().id(9).name("Category 1").build();
        Country country1 = new Country("IND", "India", UUID.randomUUID(), "IN");
        Indicator indicator1 = Indicator.builder().indicatorId(1).rank(1).build();
        CountryHealthIndicator mock1 = CountryHealthIndicator.builder()
                .countryHealthIndicatorId(new CountryHealthIndicatorId("IND", 9, 1, "2024"))
                .country(country1)
                .category(category1)
        ...
        Country country2 = new Country("USA", "United States", UUID.randomUUID(), "US");
        Indicator indicator2 = Indicator.builder().indicatorId(2).rank(2).build();
        CountryHealthIndicator mock2 = CountryHealthIndicator.builder()
                .countryHealthIndicatorId(new CountryHealthIndicatorId("USA", 8, 2, "2023"))
                .country(country2)
                .category(category2)
        ...
        when(iCountryHealthIndicatorRepository.findLatestByCountryAndCategoryAndStatus(null, null, PUBLISHED.name()))
                .thenReturn(asList(mock1, mock2));
        when(iCountryPhaseRepository.findByLatestTrueAndCountryPhaseIdCountryIdIn(anyList()))
                .thenReturn(asList(new CountryPhase("IND", 1, "2024", true),
                        new CountryPhase("USA", 3, "2023", true)));
        when(iCountrySummaryRepository.findLatestByCountryIdsAndStatus(anyList(), eq(PUBLISHED.name())))
                .thenReturn(asList(
                        CountrySummary.builder()
                                .countrySummaryId(new CountrySummaryId("IND", "2024"))
                                .build(),
                        CountrySummary.builder()
                                .countrySummaryId(new CountrySummaryId("USA", "2023"))
                                .build()));

        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(9, "Category 1", 1.0, 1,
                of(new IndicatorScoreDto(1, null, null, null, null, 1, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoIN =
                new CountryHealthScoreDto("IND", "India", "IN", of(categoryHealthScoreDto1), 1, "");
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(8, "Category 2", 2.0, 2,
                of(new IndicatorScoreDto(2, null, null, null, null, 2, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoUS =
                new CountryHealthScoreDto("USA", "United States", "US", of(categoryHealthScoreDto2), 3, "");
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(en, countryHealthScoreDtoIN))
                .thenReturn(countryHealthScoreDtoIN);
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(en, countryHealthScoreDtoUS))
                .thenReturn(countryHealthScoreDtoUS);

        CountriesHealthScoreDto countriesHealthScoreDto =
                countryHealthIndicatorService.fetchCountriesLatestHealthScores(null, null, en);

        assertThat(countriesHealthScoreDto.getCountryHealthScores().size(), is(2));
        CountryHealthScoreDto actualInd = countriesHealthScoreDto.getCountryHealthScores().stream()
                .filter(country -> country.getCountryId().equals("IND"))
                .findFirst()
                .get();
        CountryHealthScoreDto actualUsa = countriesHealthScoreDto.getCountryHealthScores().stream()
                .filter(country -> country.getCountryId().equals("USA"))
                .findFirst()
                .get();
        assertThat(actualInd.getCountryPhase(), is(1));
        assertThat(actualUsa.getCountryPhase(), is(3));
        verify(iCountryHealthIndicatorRepository).findLatestByCountryAndCategoryAndStatus(null, null, PUBLISHED.name());
        verify(iCountryPhaseRepository).findByLatestTrueAndCountryPhaseIdCountryIdIn(anyList());
        verify(iCountrySummaryRepository).findLatestByCountryIdsAndStatus(anyList(), eq(PUBLISHED.name()));
    }
    ...
    public void shouldReturnEmptyListWhenPhaseForGivenCategoryIsNotPresentWhileFetchingGlobalHealthScores() throws Exception {
        ...
        CountryHealthIndicator mock1 =
                CountryHealthIndicator.builder().country(country1).category(category1).indicator(indicator1).score(1).build();

        Category category2 = Category.builder().id(8).name("Category 2").build();
        Country country2 = new Country(USA, "United States", UUID.randomUUID(), "US");
        Indicator indicator2 = Indicator.builder().indicatorId(2).build();
        CountryHealthIndicator mock2 =
                CountryHealthIndicator.builder().country(country2).category(category2).indicator(indicator2).score(2).build();

        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdCategoryIdAndCountryHealthIndicatorIdYearAndStatus(1, year,
                PUBLISHED.name())).thenReturn(asList(mock1, mock2));

        CountrySummary countrySummary = CountrySummary.builder().build();
        when(iCountrySummaryRepository.findByCountrySummaryIdCountryIdAndCountrySummaryIdYearAndStatus(anyString(),
                anyString(), anyString())).thenReturn(countrySummary);
        ...
        CountriesHealthScoreDto countriesHealthScoreDto = countryHealthIndicatorService.fetchCountriesHealthScores(1,
                5, en, year);
    ...
    public void shouldFetchIndicatorsBasedOnFilters() throws Exception {
        ...
        Indicator indicator1 = Indicator.builder().indicatorId(1).rank(1).build();
        CountryHealthIndicator mock1 =
                CountryHealthIndicator.builder().country(country1).category(category3).indicator(indicator1).score(1).build();

        Country country2 = new Country("USA", "United States", UUID.randomUUID(), "US");

        Indicator indicator3 = Indicator.builder().indicatorId(3).rank(3).build();
        CountryHealthIndicator mock3 =
                CountryHealthIndicator.builder().country(country2).category(category3).indicator(indicator3).score(3).build();

        Indicator indicator4 = Indicator.builder().indicatorId(4).rank(4).build();
        CountryHealthIndicator mock4 =
                CountryHealthIndicator.builder().country(country2).category(category3).indicator(indicator4).score(4).build();
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdCategoryIdAndCountryHealthIndicatorIdYearAndStatus(3, year,
                PUBLISHED.name())).thenReturn(asList(mock1, mock3, mock4));
        ...
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(7, "Category 4", 3.5, 4,
                of(new IndicatorScoreDto(3, null, null, null, null, 3, null, null),
                        new IndicatorScoreDto(4, null, null, null, null, 4, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoUS = new CountryHealthScoreDto("USA", "United States", "US",
                of(categoryHealthScoreDto2), 4, "");
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(en, countryHealthScoreDtoUS)).thenReturn(countryHealthScoreDtoUS);

        CountriesHealthScoreDto countriesHealthScoreDto = countryHealthIndicatorService.fetchCountriesHealthScores(3,
                4, en, year);
        ...
        assertThat(countriesHealthScoreDto.getCountryHealthScores().get(0).getCategories().get(0).getOverallScore(),
                is(3.5));
    ...
    public void shouldFilterAtCountryLevelIfCategoryIsNull() throws Exception {
        ...
        CountryHealthIndicator mock1 =
                CountryHealthIndicator.builder().country(country1).category(category3).indicator(indicator1).score(1).build();
        CountryHealthIndicator mock2 =
                CountryHealthIndicator.builder().country(country2).category(category3).indicator(indicator4).score(2).build();
        CountryHealthIndicator mock3 =
                CountryHealthIndicator.builder().country(country2).category(category3).indicator(indicator3).score(3).build();
        CountryHealthIndicator mock4 =
                CountryHealthIndicator.builder().country(country2).category(category2).indicator(indicator5).score(5).build();
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdYearAndStatus(year, PUBLISHED.name())).thenReturn(asList(mock1, mock2,
                mock3, mock4));

        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(6, "Category 4", 5.0, 5, of(new IndicatorScoreDto(5, null, null
                , null, null, 5, null, null)));
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(7, "Category 4", 2.5, 3, of(new IndicatorScoreDto(3, null, null
                        , null, null, 3, null, null),
                new IndicatorScoreDto(4, null, null, null, null, 2, null, null)));

        CountryHealthScoreDto countryHealthScoreDtoUS = new CountryHealthScoreDto("USA", "United States", "US",
                of(categoryHealthScoreDto1,
                        categoryHealthScoreDto2), 4, "");
        ...
        CountriesHealthScoreDto countriesHealthScoreDto =
                countryHealthIndicatorService.fetchCountriesHealthScores(null, 4, en, year);

        assertThat(countriesHealthScoreDto.getCountryHealthScores().size(), is(1));
        assertThat(countriesHealthScoreDto.getCountryHealthScores().get(0).getCountryPhase(), is(4));
        List<CategoryHealthScoreDto> categories =
                countriesHealthScoreDto.getCountryHealthScores().get(0).getCategories();
    ...
    public void shouldFetchOverAllCategoriesWithScore() {
        ...
        List<CountryHealthIndicator> countryHealthIndicators = asList(countryHealthIndicator, countryHealthIndicator1, countryHealthIndicator2,
                countryHealthIndicator3, countryHealthIndicator4);
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdYearAndStatus(year, PUBLISHED.name())).thenReturn(countryHealthIndicators);
        ...
        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(3, "Category 2", 2.0, 2, of(new IndicatorScoreDto(1, null, null
                , null, null, 2, null, null)));
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(9, "Category 1", 5.0, 5, of(new IndicatorScoreDto(1, null, null
                , null, null, 5, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoIN = new CountryHealthScoreDto("IND", "India", "IN", of(categoryHealthScoreDto1,
                categoryHealthScoreDto2), 4, "");
        CategoryHealthScoreDto categoryHealthScoreDto3 = new CategoryHealthScoreDto(3, "Category 2", -1.0, -1, of(new IndicatorScoreDto(1, null,
                null, null, null, -1, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoUK = new CountryHealthScoreDto("UK", "UK", "UK", of(categoryHealthScoreDto3), null, "");
        CategoryHealthScoreDto categoryHealthScoreDto4 = new CategoryHealthScoreDto(3, "Category 2", -1.0, -1, of(new IndicatorScoreDto(1, null,
                null, null, null, null, null, null)));
        CategoryHealthScoreDto categoryHealthScoreDto5 = new CategoryHealthScoreDto(9, "Category 1", 2.0, 2, of(new IndicatorScoreDto(1, null, null
                , null, null, 2, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoUS = new CountryHealthScoreDto("USA", "USA", "US", of(categoryHealthScoreDto4,
                categoryHealthScoreDto5), 2, "");

        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(null, countryHealthScoreDtoIN)).thenReturn(countryHealthScoreDtoIN);
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(null, countryHealthScoreDtoUK)).thenReturn(countryHealthScoreDtoUK);
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(null, countryHealthScoreDtoUS)).thenReturn(countryHealthScoreDtoUS);
        ...
        CategoryHealthScoreDto actualCategory =
                globalHealthIndicator.getCategories().stream().filter(cat -> cat.getId().equals(category.getId())).findFirst().get();
    ...
    public void fetchGlobalHealthScoresShouldIgnoreCountryWithAllIndicatorsMissing() {
        ...
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdCategoryIdAndCountryHealthIndicatorIdYearAndStatus(1, "Version1",
                PUBLISHED.name())).thenReturn(countryHealthIndicators);
        ...
        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(8, "Category 2", 2.0, 2, of(new IndicatorScoreDto(0, null, null
                , null, null, 2, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoIN = new CountryHealthScoreDto("IND", null, null,
                of(categoryHealthScoreDto1), 2, "");
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(null, countryHealthScoreDtoIN)).thenReturn(countryHealthScoreDtoIN);
    ...
    public void shouldConsiderOnlyCategoriesWithGivenPhase() throws Exception {
        ...
        CountryHealthIndicator countryHealthIndicator = CountryHealthIndicator.builder()
                ...
                .countryHealthIndicatorId(
                        new CountryHealthIndicatorId("Ind", category.getId(), 1, "Version1"))
                .indicator(Indicator.builder().indicatorId(1).rank(1).build())
                .category(category).score(5).status(PUBLISHED.name()).build();
        ...
        CountryHealthIndicator countryHealthIndicator1 = CountryHealthIndicator.builder()
                ...
                .category(category).score(2).status(PUBLISHED.name()).build();

        CountryHealthIndicator countryHealthIndicator2 = CountryHealthIndicator.builder()
                .country(new Country("USA", "USA", UUID.randomUUID(), "US"))
                .countryHealthIndicatorId(
                        new CountryHealthIndicatorId("USA", category.getId(), 1, "Version1"))
        ...
        CountryHealthIndicator countryHealthIndicator3 = CountryHealthIndicator.builder()
                ...
                .category(category).score(1).status(PUBLISHED.name()).build();
        ...
        CountryHealthIndicator countryHealthIndicator4 = CountryHealthIndicator.builder()
                ...
                .category(category).score(null).status(PUBLISHED.name()).build();
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdCategoryIdAndCountryHealthIndicatorIdYearAndStatus(category.getId(),
                year, PUBLISHED.name())).thenReturn(asList(countryHealthIndicator, countryHealthIndicator1, countryHealthIndicator2,
                countryHealthIndicator3, countryHealthIndicator4));
        ...
        CategoryHealthScoreDto categoryHealthScoreDto = new CategoryHealthScoreDto(9, "Category 1", 1.5, 2, of(new IndicatorScoreDto(1, null, null,
                        null, null, 2, null, null),
                new IndicatorScoreDto(2, null, null, null, null, 1, null, null),
                new IndicatorScoreDto(3, null, null, null, null, null, null, null)));
        CountryHealthScoreDto countryHealthScoreDtoUS = new CountryHealthScoreDto("USA", "USA", "US",
                of(categoryHealthScoreDto), 2, "");

        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(null, countryHealthScoreDtoUS)).thenReturn(countryHealthScoreDtoUS);

        GlobalHealthScoreDto globalHealthIndicator =
                countryHealthIndicatorService.getGlobalHealthIndicator(category.getId(), 2, en, year);

        assertEquals(2, globalHealthIndicator.getOverAllScore().intValue());
        assertEquals(1, globalHealthIndicator.getCategories().size());
        assertEquals(1.5, globalHealthIndicator.getCategories().get(0).getOverallScore());
    ...
    public void shouldInvokeConvertExcelOnGlobalExportForFrenchForAGivenYear() throws IOException, ParseException {
        ...
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdYearAndStatus(year, PUBLISHED.name())).thenReturn(asList(mock1));
        ...
        IndicatorScoreDto indicatorScore = new IndicatorScoreDto(1, null, null, null, null, 1, null, null);
        CategoryHealthScoreDto categoryScore = new CategoryHealthScoreDto(9, "Category 1", 1.0, 1, of(indicatorScore));
        CountryHealthScoreDto countryHealthScore = new CountryHealthScoreDto("IND", "India", "IN", of(categoryScore), 1, "");
        IndicatorScoreDto indicatorScoreFR = new IndicatorScoreDto(1, null, null, null, null, 1, null, null);
        CategoryHealthScoreDto categoryScoreFR = new CategoryHealthScoreDto(9, "Category 1", 1.0, 1, of(indicatorScoreFR));
        CountryHealthScoreDto countryHealthScoreFR = new CountryHealthScoreDto("IND", "Inde", "IN", of(categoryScoreFR), 1, "");
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(fr, countryHealthScore)).thenReturn(countryHealthScoreFR);
        ...
        verify(indicatorTranslator).translateCountryHealthScoreCountryNameAndCategory(fr, countryHealthScore);
    }
    ...
    public void shouldInvokeConvertExcelOnExportOfSingleCountryForAGivenYear() throws IOException {
        ...
        IndicatorScore indicatorScore =
                IndicatorScore.builder().id(1L).indicatorId(1).score(1).definition("score 1").build();
        CountryHealthIndicatorId countryHealthIndicatorId = new CountryHealthIndicatorId(country.getId(),
                category.getId(), indicator.getIndicatorId(), year);

        CountryHealthIndicator countryHealthIndicator = new CountryHealthIndicator(countryHealthIndicatorId,
                country, category, indicator, indicatorScore, 1, "st3", new Date(), null, "PUBLISHED");

        List<CountryHealthIndicator> countryHealthIndicatorsForCountry = asList(countryHealthIndicator);
        when(iCountryHealthIndicatorRepository.findByCountryHealthIndicatorIdCountryIdAndCountryHealthIndicatorIdYearAndStatus("IND", "Version1",
                "PUBLISHED"))
    ...
    public void shouldInvokeHealthIndicatorTranslatorWithLanguageAsFrench() throws IOException {
        ...
        CountryHealthIndicatorId countryHealthIndicatorId = new CountryHealthIndicatorId(country.getId(),
                category.getId(),
                indicator.getIndicatorId(), year);

        CountryHealthIndicator countryHealthIndicator = new CountryHealthIndicator(countryHealthIndicatorId, country,
                category, indicator,
                indicatorScore, 1, "st3", new Date(), null, "PUBLISHED");
        ...
        IndicatorScoreDto indicatorScoreDto = new IndicatorScoreDto(1, null, "Indicator 1", "Definition1", 1, 1, "st3"
                , "score 1");
        CategoryHealthScoreDto categoryScore = new CategoryHealthScoreDto(1, "Leadership and Governance", 1.0, 1,
                of(indicatorScoreDto));
        CountryHealthScoreDto countryHealthScoreDto = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryScore), 1, "");
    ...
    public void shouldTranslateCategoryNameToGivenUserLanguageForGlobalHealthIndicators() {
        ...
        CategoryHealthScoreDto categoryHealthScoreDto1 = new CategoryHealthScoreDto(3, "Workforce", 2.0, 2, of(new IndicatorScoreDto(1, null, null,
                null, null, 2, null, null)));
        CategoryHealthScoreDto categoryHealthScoreDto2 = new CategoryHealthScoreDto(9, "Legislation, Policy, and " +
                "Compliance", 5.0, 5, of(new IndicatorScoreDto(1, null, null, null, null, 5, null, null)));
        CountryHealthScoreDto countryHealthScoreDto = new CountryHealthScoreDto("IND", "India", "IN",
                of(categoryHealthScoreDto1,
                        categoryHealthScoreDto2), 4, "");
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(null, countryHealthScoreDto)).thenReturn(countryHealthScoreDto);
    ...
    public void shouldTranslateCountriesHealthIndicatorsToFrench() throws Exception {
        ...
        CountryHealthScoreDto countryHealthScoreFR = new CountryHealthScoreDto("IND", "Inde",
                "IN", of(categoryScoreFR), 1, "");
        when(indicatorTranslator.translateCountryHealthScoreCountryNameAndCategory(fr, countryHealthScore)).thenReturn(countryHealthScoreFR);

        countryHealthIndicatorService.fetchCountriesHealthScores(null, null, fr, year);
