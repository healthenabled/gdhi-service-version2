...
public class CountryHealthIndicatorServiceTest {
    ...
    private void dataSet(String countryId1, int categoryId1, int categoryId2,
        ...
        CountryHealthIndicatorId countryHealthIndicatorId1 = new CountryHealthIndicatorId(countryId1, categoryId1, indicatorId1, year);
        ...
        CountryHealthIndicatorId countryHealthIndicatorId2 = new CountryHealthIndicatorId(countryId1, categoryId2, indicatorId2, year);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForDifferentNullIndicatorScoreForSameCategory() {
        ...
        CountryHealthIndicator countryHealthIndicator1 = new CountryHealthIndicator(countryHealthIndicatorId1,
                country1, category1, indicator1, IndicatorScore.builder().build(), null, null, new Date(), null,publishedStatus);

        CountryHealthIndicatorId countryHealthIndicatorId2 = new CountryHealthIndicatorId(countryId, categoryId1, indicatorId2, year);
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        Integer indicatorScore = 2;
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category1, indicator2, IndicatorScore.builder().build(), indicatorScore, "st1", new Date(), null,publishedStatus);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForANullCategoryScore() {
        ...
        Indicator indicator1 = new Indicator(indicatorId1, "Indicator 1", "Definition", 1);
        CountryHealthIndicator countryHealthIndicator1 = new CountryHealthIndicator(countryHealthIndicatorId1,
                country1, category1, indicator1, IndicatorScore.builder().build(), null, "st1", new Date(), null,publishedStatus);

        CountryHealthIndicatorId countryHealthIndicatorId2 = new CountryHealthIndicatorId(countryId1, categoryId1, indicatorId2, year);
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category2, indicator2, IndicatorScore.builder().build(), 2, "st2", new Date(), null,publishedStatus);
    ...
    public void shouldReturnCountryHealthScoreWithoutConsideringNegativeScores() {
        ...
        String publishedStatus = "PUBLISHED";
        String year = "Version1";
        CountryHealthIndicatorId countryHealthIndicatorId1 = new CountryHealthIndicatorId(countryId, categoryId1, indicatorId1, year);
        Country country1 = new Country(countryId, countryName, UUID.randomUUID(), "IN");
        Category category1 = new Category(categoryId1, categoryName);
        Category category2 = new Category(categoryId2, categoryName2);
        Indicator indicator1 = new Indicator(indicatorId1, "Indicator 1", "Definition", 1);
        ...
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category2, indicator2, IndicatorScore.builder().indicatorId(indicatorId2).score(2).build(), 2, "st2", new Date(), null,publishedStatus);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForNullCountryScore() {
        ...
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category1, indicator2, IndicatorScore.builder().build(), null, null, new Date(), null,publishedStatus);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForSameCategory() {
        ...
        Indicator indicator1 = new Indicator(indicatorId1, "Indicator 1", "Definition", 1);
        CountryHealthIndicator countryHealthIndicator1 = new CountryHealthIndicator(countryHealthIndicatorId1,
                country1, category1, indicator1, IndicatorScore.builder().build(), indicatorScore1, "st1", new Date(), null,publishedStatus);

        CountryHealthIndicatorId countryHealthIndicatorId2 = new CountryHealthIndicatorId(countryId, categoryId1, indicatorId2, year);
        Indicator indicator2 = new Indicator(indicatorId2, "Indicator 1", "Definition", 2);
        CountryHealthIndicator countryHealthIndicator2 = new CountryHealthIndicator(countryHealthIndicatorId2,
                country1, category1, indicator2, IndicatorScore.builder().build(), indicatorScore2, "st2", new Date(), null,publishedStatus);
    ...
    public void shouldReturnCountryHealthScoreGivenCountryIdAndYearForSameCategoryCheckingSinglePrecision() {
        ...
        CountryHealthIndicatorId countryHealthIndicatorId3 = new CountryHealthIndicatorId(countryId1, categoryId1, indicatorId3, year);
        ...
        CountryHealthIndicator countryHealthIndicator3 = new CountryHealthIndicator(countryHealthIndicatorId3,
                country1, category1, indicator3, IndicatorScore.builder().build(), indicatorScore3, "st3", new Date(), null,publishedStatus);
    ...
    public void shouldFetchGlobalHealthScores() throws Exception {
        ...
        when(iCountryHealthIndicatorRepository.findByStatusAndCountryHealthIndicatorIdYear(PUBLISHED.name(), year)).thenReturn(asList(mock1, mock2, mock3, mock4));

        CountrySummary countrySummary = CountrySummary.builder().build();
        when(iCountrySummaryRepository.findByCountrySummaryIdCountryIdAndCountrySummaryIdYearAndStatus(anyString(), anyString(), anyString())).thenReturn(countrySummary);
        ...
        CountryHealthScoreDto countryHealthScoreDtoUS = new CountryHealthScoreDto("USA", "United States", "US", of(categoryHealthScoreDto2, categoryHealthScoreDto3), 3, "");
    ...
    public void shouldFilterAtCountryLevelIfCategoryIsNull() throws Exception {
        ...
        CountryHealthScoreDto countryHealthScoreDtoUS = new CountryHealthScoreDto("USA", "United States", "US", of(categoryHealthScoreDto1, categoryHealthScoreDto2), 4, "");
    ...
    public void shouldFetchOverAllCategoriesWithScore() {
        ...
        when(iCountryHealthIndicatorRepository.findByStatusAndCountryHealthIndicatorIdYear(PUBLISHED.name(), year)).thenReturn(countryHealthIndicators);
    ...
    public void shouldConsiderOnlyCategoriesWithGivenPhase() throws Exception {
        ...
        CategoryHealthScoreDto categoryHealthScoreDto = new CategoryHealthScoreDto(9, "Category 1", 1.5, 2,
    ...
    public void shouldInvokeConvertExcelOnGlobalExportForFrenchForAGivenYear() throws IOException, ParseException {
        ...
        when(iCountryHealthIndicatorRepository.findByStatusAndCountryHealthIndicatorIdYear(PUBLISHED.name(), year)).thenReturn(asList(mock1));
    ...
    public void shouldInvokeHealthIndicatorTranslatorWithLanguageAsFrench() throws IOException {
        ...
        IndicatorScore indicatorScore = IndicatorScore.builder().id(1L).indicatorId(1).score(1).definition("score 1").build();
        String year = "Version1";
        CountryHealthIndicatorId countryHealthIndicatorId = new CountryHealthIndicatorId(country.getId(), category.getId(), indicator.getIndicatorId(), year);
