...
public class ICountryPhaseRepositoryTest {
    ...
    @Test
    public void shouldReturnDistinctYearsForAPublishedCountries() {
        String countryIdInd = "IND";
        String countryIdPak = "PAK";
        addCountryPhase(countryIdInd, 2, "2018");
        addCountryPhase(countryIdPak, 4, "2022");

        List<String> actual = iCountryPhaseRepository.findAllDistinctYearsOrderByUpdatedAtDesc(2);
        List<String> expected = asList("2022", "2018");
