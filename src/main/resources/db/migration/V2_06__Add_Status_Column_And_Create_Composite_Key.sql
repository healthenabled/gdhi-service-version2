...
ALTER TABLE country_health_data.country_resource_links ADD CONSTRAINT country_resource_links_fkey FOREIGN KEY (country_id, status) REFERENCES country_health_data.country_summary (country_id, status);
...
ALTER TABLE country_health_data.health_indicators ADD CONSTRAINT health_indicators_country_id_status_fkey FOREIGN KEY (country_id, status) REFERENCES country_health_data.country_summary (country_id, status);
